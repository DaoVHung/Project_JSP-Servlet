  ...
  <nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="DrinksServlet">
            <i class="align-middle" data-feather="square"></i> <span class="align-middle">Drinks List</span>
          </a>
        </li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="FoodServlet">
            <i class="align-middle" data-feather="square"></i> <span class="align-middle">Food List</span>
          </a>
        </li>
        <li class="sidebar-item active">
          <a class="sidebar-link" href="#">
            <i class="align-middle" data-feather="square"></i> <span class="align-middle">Table List</span>
          </a>
        </li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="BillServlet">
            <i class="align-middle" data-feather="square"></i> <span class="align-middle">Bill List</span>
          </a>
        </li>
        <li class="sidebar-item">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped text-center">
              ...
              <tbody>
              <c:forEach items="${drinksList}" var="d">
                <tr>
                  <td>${d.drinksID}</td>
                  <td>${d.catalogID}</td>
                  <td>${d.drinksName}</td>
