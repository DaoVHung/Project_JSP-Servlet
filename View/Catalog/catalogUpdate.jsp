                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <h2>Nhập thông tin muốn cập nhật !</h2>
                            </div>
                        </nav>
                    </div>
<!--====================================================================================================================================== -->
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/CatalogServlet" method="post">
                            <table id="example1" class="table table-bordered table-striped text-center">
                                <tr>
                                    <td>Catalog ID</td>
                                    <td><input type="text" name="catalogID" value="${cataUpdate.catalogID}" readonly></td>
                                </tr>
                                <tr>
                                    <td>Catalog Name</td>
                                    <td><input type="text" name="catalogName" value="${cataUpdate.catalogName}"></td>
                                </tr>
                                <tr>
                                    <td>Title</td>
                                    <td><input type="text" name="title" value="${cataUpdate.title}"></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td>
                                        <input type="radio" name="status" id="active" value="true"/><label for="active">✔</label>
                                        <input type="radio" name="status" id="inactive" value="false"/><label for="inactive">✖</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input class="btn btn-outline-success" type="submit" value="Update" name="action">
                                    </td>
                                </tr>
                            </table>
                        </form>
