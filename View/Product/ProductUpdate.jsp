                    ...
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/ProductServlet" method="post" enctype="multipart/form-data">
                            <table id="example1" class="table table-bordered table-striped text-center">
                                ...
                                <tr>
                                    <td>Product Image</td>
                                    <td><input type="file" name="productImg" value="${productUpdate.productImg}" ><img
                                            src="<%=request.getContextPath()%>/images/${productUpdate.productImg}" alt=""> </td>
                                </tr>
                                <tr>
                                    <td>Sub Image</td>
                                    <td><input type="file" name="subImg" value="" multiple>
                                        <c:forEach items="${productUpdate.listImgLinks}" var="imgLinks">
                                            <img src="<%=request.getContextPath()%>/images/${imgLinks}" alt="">
                                        </c:forEach>
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="container-fluid">
                <div class="row text-muted">
                    <div class="col-6 text-start">
                        <p class="mb-0">
                            <a class="text-muted" href="" target="_blank"><strong>Gent Steak</strong></a>
