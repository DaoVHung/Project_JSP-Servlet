    ...
    <main class="content">
      <div  class="container-fluid p-0">
        <div class="card">
          ...
          <div class="container">
            <div  class="card">
              <div id="fli"  class="container-fliud">
                <div id="wrapper" class="wrapper row">
                  <div class="preview col-md-6">
                    <div class="preview-pic tab-content">
                      <div class="tab-pane active" id="pic-1"><img
                              src="<%=request.getContextPath()%>/images/${proDetail.productImg}" alt=""></div>
                    </div>
                    <ul class="preview-thumbnail nav nav-tabs">
                      <c:forEach items="${proDetail.listImgLinks}" var="imgLinks">
                        <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="<%=request.getContextPath()%>/images/${imgLinks}" /></a></li>
                      </c:forEach></td>
                    </ul>
                  </div>
                  <div class="details col-md-6">
                    <h3 class="product-title">${proDetail.productName}</h3>
                    <div class="rating">
                      <div class="stars">
                      ...
                      <h4 class="price">price: <span>${proDetail.price}</span> VNĐ</h4>
