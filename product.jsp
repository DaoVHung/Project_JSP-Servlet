    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="FoodServlet">
                        <i class="bi bi-fire"></i> <span class="align-middle">Food List</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="FoodServlet">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="<%=request.getContextPath()%>/ProductServlet?action=newProduct">
                                    <button type="button" class="btn btn-outline-success">+ Add new Product</button>
                                </a>
                                <form class="d-flex" role="search" action="<%=request.getContextPath()%>/ProductServlet" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-danger">
                                            <a type="button" href="#deleteProductModal" class="delete" data-bs-toggle="modal"><i class="bi bi-trash3"></i></a>
                                            <input type="hidden" id="proIdDele" value="${d.productID}"/>
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-outline-success">
                                            <a id="update"
                                               href="<%=request.getContextPath()%>/ProductServlet?productID=${d.productID}&&action=Update"><i class="bi bi-gear"></i></a>
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-outline-primary">
                                            <a id="detail"
                                               href="<%=request.getContextPath()%>/ProductServlet?productID=${d.productID}&&action=GetByID"><i class="bi bi-card-heading"></i></a>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script type="text/javascript">
    $(document).on('click', 'table .delete', function () {
        let proId = $(this).parent().find('#proIdDele').val();
        $('#deleteProductModal #proProductId').val(proId);
        console.log(proId);
    });
</script>
<%--=============================================================  Modal Delete =============================================================== --%>
