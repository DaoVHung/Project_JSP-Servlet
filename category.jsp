...
<head>
    ...
    <link rel="stylesheet" href="câtlog.js">
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="TableServlet">
                        <i class="bi bi-book-half"></i> <span class="align-middle">Table List</span>
                    </a>
                </li>
                <li class="sidebar-item">
                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            ...
                            <span class="text-dark">Hưng Béoo</span>
                        </a>
...
<!--================================================================ Modal Create ====================================================================================-->
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="card-body">
                                                    <form action="<%=request.getContextPath()%>/CatalogServlet" method="POST">
                                                        <table id="example12" class="table table-bordered table-striped text-center">
                                                            <tr>
                                                                <td colspan="2">
                                                                    <h3>Nhập thông tin danh mục mới !</h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Catalog Name</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="radio" name="status" id="inactive" value="false"/><label
                                                                        for="inactive">✖ Inactive ️</label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-outline-warning" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" value="Create" name="action" class="btn btn-outline-success">Save changes</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <form class="d-flex" role="search" action="<%=request.getContextPath()%>/CatalogServlet" method="post">
                                    <input class="form-control me-2 fst-italic" type="text"
                                           placeholder="Enter catalog name... "
                                           aria-label="Search" name="catalogName">
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${catalogList}" var="c">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${c.catalogStatus}">✔</c:when>
                                            <c:otherwise>✖</c:otherwise>
                                        </c:choose>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-outline-danger">
                                            <a type="button" href="#deleteCatalogModal" class="delete" data-bs-toggle="modal"><i class="bi bi-trash3"></i></a>
                                            <input type="hidden" id="catIdDele" value="${c.catalogID}"/>
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-outline-success">
                                            <a id="update"
                                               href="<%=request.getContextPath()%>/CatalogServlet?catalogID=${c.catalogID}&&action=Update"><i class="bi bi-gear"></i></a>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
        ...
        <div class="modal-content">
            ...
            <form action="<%=request.getContextPath()%>/CatalogServlet" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="catCatalogId" id="catCatalogId"/>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).on('click', 'table .delete', function () {
        let catId = $(this).parent().find('#catIdDele').val();
        $('#deleteCatalogModal #catCatalogId').val(catId);
        console.log(catId);
    });
</script>
<%--=============================================================  Modal Delete =============================================================== --%>
